  ...
  return (
    <div className="bg-gradient-to-b from-black via-gray-900 to-black text-gray-100">
      ...
      <motion.header
        ...
        className="bg-gradient-to-r from-gray-900 via-black to-gray-800 text-white py-20 text-center shadow-lg"
      >
        <motion.h1
      ...
      <main className="max-w-6xl mx-auto p-10 space-y-32">
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-gray-300">
            Analytical and technically skilled graduate in Computer Science, Mathematics and Industrial
            Mathematics with strong IT proficiency. Seeking a role that leverages my analytical thinking,
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <motion.div
                ...
                variants={fadeInUp}
                custom={i + 1}
                className="bg-gray-800 p-6 rounded-xl shadow-md hover:-translate-y-2 transition transform"
              >
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {[
              {
                title: "Studying Time Optimizing Website",
                stack: "Java, React, Node.js",
                desc: "Designed a website that optimizes studying hours for university students to increase GPA performance.",
              },
              {
                title: "BookShop Management System Website",
                stack: "JavaScript, CSS, HTML",
                desc: "Developed a simple and efficient bookshop management web application.",
              },
            ].map((proj, i) => (
              <motion.div key={i} variants={fadeInUp} custom={i + 1}>
                <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-md hover:shadow-2xl transition transform hover:-translate-y-2">
                  <div className="p-8">
                    <h3 className="font-bold text-2xl text-white mb-4">{proj.title}</h3>
                    <p className="text-sm font-semibold text-blue-400 mb-4">{proj.stack}</p>
        ...
        >
          ...
          <div className="space-y-6 text-xl text-gray-300">
            <motion.p variants={fadeInUp} custom={1} className="flex items-center gap-3">
              <Phone size={24} className="text-gray-400" /> 0767589462
            </motion.p>
            <motion.p variants={fadeInUp} custom={2} className="flex items-center gap-3">
              <Mail size={24} className="text-gray-400" /> dasun.darshaka01@gmail.com
            </motion.p>
            <motion.p variants={fadeInUp} custom={3} className="flex items-center gap-3">
              <MapPin size={24} className="text-gray-400" /> 278, Horana Road, Pamunugama, Alubomulla
            </motion.p>
            <motion.p variants={fadeInUp} custom={4} className="flex items-center gap-3">
              <Linkedin size={24} className="text-gray-400" />{" "}
              <a
                className="text-blue-400 hover:underline"
                href="https://www.linkedin.com/in/dasundarshaka"
              >
                linkedin.com/in/dasundarshaka
              </a>
            </motion.p>
            <motion.p variants={fadeInUp} custom={5} className="flex items-center gap-3">
              <Github size={24} className="text-gray-400" />{" "}
              <a className="text-blue-400 hover:underline" href="https://github.com/dasundarshaka">
                github.com/dasundarshaka
              </a>
            </motion.p>
          </div>
        </motion.section>
